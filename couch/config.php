<?php
    ...
    define( 'K_DB_NAME', 'cbaker_couchcms' );
    // 5.
    // Database username
    define( 'K_DB_USER', 'cbaker_couch' );
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'P@55word!' );
    // 7.
