...
<body class="bg-primary">
    ...
    <div class="mt-5 p-5 bg-light container custom-padding offset">
        ...
        <p>Our mission is to make high-quality computer science an integral part of the educational experience of all K-12 students and teachers and to support student pathways to college and career success.</p>
				...
				<cms:form method="post" class="border border-primary rounded p-3">
					<cms:fieldset label="Take The Pledge">
					<p class="lead text-primary">I hereby pledge to support computer science for all Kentucky students.</p>					
							<cms:input type="text" name="first" label="First Name" required='1' class="form-control "/>
							<cms:input type="text" name="last" label="Last Name" required='1' class="form-control "/>				
							<cms:input type="text"
											name="email"
											label='Email'
											maxlength="100"
                       ...
                       name="county"
                       label='Select Your County / School District'
                       ...
                       required='1' 
							...
							<cms:input type="radio"
											name="age"
											label='Age'
											opt_values="11 years and under=elementary | 12-14 years=middle | 15-19 years=high | over 19 years=adult" />
							<cms:input type="radio"
											name="role"
											label='Role'
											opt_values="Comunity Member=community | Educator=educator | Student=student | Parent=parent" />
